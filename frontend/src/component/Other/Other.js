...
import web from "../../imgs/ctf.png";
import api from "../../images/api.png";
import service from "../../images/network.png";
import ReCAPTCHA from "react-google-recaptcha";
import { Alert } from "@mui/material";
import webi from "../../imgs/webi.png";
import emp from "../../imgs/55.png";
                        ...
                        <ScrollAnimation animateIn="fadeIn" animateOnce="true">
                            <div className="why">
                                ...
                                <div className="cards vap">
                                    ...
                                    <div className={isimg ?"card" : 'mobilecard'} >
                                        <div className={isimg ? "card-data gj" : "mobil-card-data gj"}>
                                            <img className="card-img" src={webi}  />
